<h2><a href="https://leetcode.com/problems/minimum-operations-to-form-subset-sum-i">Minimum Operations to Form Subset Sum I</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer array <code>nums</code> and an integer <code>sum</code>.</p>
